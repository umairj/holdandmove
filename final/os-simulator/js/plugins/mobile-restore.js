(function($, OS) {
    ...
    function onDoTransformation (event) {
    ...
    function bindEvents() {
        $(document).on( 'onPan', onPan);

        $(document).on( 'onDoTransformation', onDoTransformation);

        $(document).on('onIdle', onIdle)
    }

    function unbindEvents() {
        $(document).unbind( 'onPan', onPan);

        $(document).unbind( 'onDoTransformation', onDoTransformation);

        $(document).unbind('onIdle', onIdle)
    }
